...
class ValueAgent(TradingAgent):
    ...
    def __init__(self, id, name, type, symbol='IBM', starting_cash=100000, sigma_n=40000,
                 r_bar=100000, kappa=0.05, sigma_s=10000,
        ...
        self.size = self.random_state.randint(1, 10)   #size that the agent will be placing
        self.depth_spread = 2
    ...
    def updateEstimates(self):
        ...
        obs_t = self.oracle.observePrice(self.symbol, self.currentTime,self.id, sigma_n=self.sigma_n,
        ...
        # print("prev_wake_time", self.prev_wake_time)
        ...
        self.sigma_t = (self.sigma_n * sigma_tprime) / (self.sigma_n + self.sigma_t)
        ...
        # print(self.r_bar, self.kappa, self.sigma_s,self.lambda_a)
    ...
    def placeOrder(self):
        ...
        r_T = self.oracle.base_observePrice(self.symbol, self.currentTime,self.id, sigma_n=self.sigma_n,
                                         random_state=self.random_state)
        bid, bid_vol, ask, ask_vol = self.getKnownBidAsk(self.symbol)
        ...
        if bid and ask:
            ...
            if self.random_state.rand() < self.percent_aggr:
                ...
                adjust_int = self.random_state.randint( 0, 10)
    ...
    def calculateSurplus(self):
        ...
        Surplus = value of holdings + cash change
